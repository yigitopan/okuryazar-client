...
<template>
  <header :class="{'bg-unscrolled opacity-80	 backdrop-blur-xl': scrolled,'bg-white': !scrolled }" class="transition ease-in-out duration-300 border-b-2 border-gray-500 w-full z-50 sticky">
      <div class="flex-col flex">
          <div class="flex flex-row items-center px-8 md:px-20 lg:px-32 justify-between sm:justify-between py-4 sm:space-x-12 font-signika">
            ...
            <div class="okuryazar-logo cursor-pointer">
              ...
              <div class="w-1/3 flex" :class="{'hidden':!searchMode}">
                ...
                <div :class="{'invert':!scrolled}" class="flex text-2xl justify-center sm:hidden">
                  ☰
                </div>
          </div>
